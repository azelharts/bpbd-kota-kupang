// app/dashboard/input-kejadian/KejadianForm.tsx
...
import { MultiSelect } from "@/app/dashboard/input-kejadian/MultiSelect";
import {
  JembatanTable,
  ManusiaTable,
  PelayananTable,
  ...
  RusakPertanianTable,
} from "@/app/dashboard/input-kejadian/tables";
import {
  jenisList,
  kecList,
  kelList,
...
type Props = {
  initialData?: FormValues; // undefined  -> new entry
};

export default function KejadianForm({ initialData }: Props) {
  ...
  useEffect(() => {
    // @ts-expect-error
    if (initialData?.fotoUrl) setPreviewUrl(initialData.fotoUrl);
  }, [initialData]);
      ...
      <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6">
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="Kota Kupang">Kota Kupang</SelectItem>
                    </SelectContent>
                  </Select>
                  <FormMessage />
                </FormItem>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem className="md:col-span-2">
                  ...
                  <FormControl>
                    <Textarea rows={3} placeholder="Penyebab …" {...field} />
                  </FormControl>
                  <FormMessage />
                </FormItem>
              )}
            ...
            <FormField
              ...
              render={() => (
                <FormItem className="md:col-span-2">
                  ...
                  <FormDescription>Maks. 5 MB (jpg/png/gif)</FormDescription>
                  <FormMessage />
                </FormItem>
              )}
            />
        ...
        <Card>
          ...
          <CardContent className="grid gap-4 md:grid-cols-2">
            {(["dana", "sdm", "sarpras", "logistik", "alat"] as const).map(
              (key) => (
                <FormField
                  key={key}
                  control={form.control}
                  name={key}
                  render={({ field }) => (
                    <FormItem className={key === "alat" ? "md:col-span-2" : ""}>
                      <FormLabel>
          ...
          <CardContent>
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormLabel>
                    Barang yang digunakan untuk melayani penanganan darurat
                    bencana
                  </FormLabel>
                  <FormControl>
                    <Textarea rows={3} {...field} />
